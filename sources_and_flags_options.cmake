...
elseif(CMAKE_Fortran_COMPILER_ID STREQUAL "Cray")
  ...
  # flags specific for offloading with Cray compiler
  if(VASP_OMP_OFFLOAD AND VASP_ROCM_HIP)
    message(STATUS "special optimizations for Cray compiler with OpenMP offloading")
    list(APPEND VASP_FORTRAN_FLAGS -hnoacc -hipa0)
    list(APPEND VASP_FORTRAN_LINKER_FLAGS -homp -hnoacc)
    set(_VASP_OFLAG_DEFAULT -O2)
    if(CMAKE_Fortran_COMPILER_VERSION VERSION_LESS "20.0")
      message(STATUS "Cray compiler version < 20.0 detected. Applying workaround for OpenMP offloading")
      set(_VASP_SOURCES_O1 openmp.F twoelectron4o.F local_field.F)
      set(_VASP_SOURCES_O2 rot.F fexcg.F mbj.F ldalib.F ggalib.F mggalib.F)
      set(_VASP_SOURCES_O3 bse.F GG_base.F)
      list(APPEND _VASP_OFLAG_O3 -hnoomp)
    endif()
  endif()
