...
#                           (no D4S model). VASP selects its code path with
#                           -DDFTD4_API_V3 in that case, -DDFTD4 otherwise.
#
...
# ---------------------------------------------------------------------------
# API selection: dftd4 4.x added the D4S model (dftd4_model_d4s.mod), which is
# what VASP uses unless DFTD4_API_V3 is defined.
# ---------------------------------------------------------------------------
if(DFTD4_FOUND)
...
if(DFTD4_FOUND)
  if(NOT DFTD4_MESSAGE_SHOWN)
    ...
    if(DFTD4_API_V3)
      message(STATUS "DFTD4 provides the v3 API - compiling with -DDFTD4_API_V3")
    else()
      message(STATUS "DFTD4 provides the v4 API (D4S model) - compiling with -DDFTD4")
    endif()
  endif()
